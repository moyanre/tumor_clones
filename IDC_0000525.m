...
Data1 = IDC_0000525_alt_count;
N_st_Matrix1 = IDC_0000525_total_count;


rep = 5; % 20...number of replicates
...
%%%%%%%  POINT ESTIMATES %%%%%%%%%%
 ...
 %%%%% pick out all particles (Z,W,p) that belong to this C-star
    ...
    indx = 2;
     ...
     geno = 'Estimate of the genotype matrix is:';
     disp(geno)
     disp(Z_est)
     ...
     prop = 'Estimate of the proportion matrix is:';
     disp(prop)
     disp(W_est)
